    ...
    <x-slot name="header">
        ...
        <a class="no-underline" href="{{ route('events.create') }}">
            <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                class="block md:hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dark:bg-alpha dark:hover:bg-alpha dark:focus:ring-blue-800"
                type="button">
                Add Event
            </button>
        </a>
        <a class="no-underline" href="{{ route('events.create') }}">
            <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                class="md:block hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-alpha dark:hover:bg-alpha dark:focus:ring-blue-800"
                type="button">
                Add Event
            </button>
        </a>
