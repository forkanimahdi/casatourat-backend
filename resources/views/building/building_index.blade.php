        ...
        <div class="w-[95%] flex flex-wrap gap-3">
            ...
            <div class="w-1/3 p-4 h-[40vh] bg-white max-w-sm rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:scale-105 transition duration-300">
                ...
                <div class="flex justify-between items-center pt-3">
                    ...
                    <button>
                        <a href="{{ route('building.show', $building) }}" class="text-gray-100 no-underline text-xs font-semibold bg-alpha py-2 px-4 rounded-lg shadow-md hover:shadow-lg hover:text-alpha hover:bg-gray-100 hover:border-2 hover:border-alpha transition duration-200 transform-gpu hover:scale-110 ">View details</a>
                    </button>
                </div>
