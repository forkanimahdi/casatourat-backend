    ...
    <form id="myForm" enctype="multipart/form-data">
        ...
        <div x-data="{
            ...
            <div x-show="step == 'Path'" class="p-[1.25rem] bg-white flex flex-col gap-3">
                ...
                <button type="sumbit" @click="step = 'Circuit Details'"
                            ...
                            <div class="flex flex-col gap-y-[0.75rem]">
                                <div class="flex flex-col gap-[0.5rem]">
                                    ...
                                    <input class="rounded w-full" type="text" id="name_en" placeholder="name"
                                        value="{{ old('name.en') }}" name="name[en]" >
                                </div>

                                <div class="flex flex-col gap-[0.5rem]">
                                    <label for="description_en" class="w-full font-bolder text-base">Text
                                        description</label>
                                    <textarea class="rounded w-full" type="text" placeholder="description" id="description_en" 
                            ...
                            <div class="flex flex-col gap-y-[0.75rem] text-end">
                                <div class="flex flex-col gap-[0.5rem]">
                                    ...
                                    <input class="rounded text-end" type="text" placeholder="الاسم"
                                        name="name[ar]" id="name.ar" value="{{ old('name.ar') }}" >
                                </div>
            ...
            <div x-show="step === 'Assign Buildings'" class="flex flex-col gap-2 p-3 bg-white">
                ...
                <div class="flex justify-between py-3">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" class="px-3 py-2 bg-alpha text-white flex items-center gap-2 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
