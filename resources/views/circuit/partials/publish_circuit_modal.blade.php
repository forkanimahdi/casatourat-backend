        ...
        <div role="alert" class="container flex justify-center items-center mx-auto w-11/12 md:w-2/3 max-w-lg">
            <div class="relative  py-8 px-5 md:px-10 w-3/5 bg-white shadow-md rounded-2xl border border-gray-400">
                <div class="text-center p-5 flex-auto justify-center">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 -m-1 flex items-center text-alpha mx-auto"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 flex items-center text-alpha mx-auto"
                    ...
                    <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                        <p class="text-sm text-gray-500 px-8">Do you really want to publish this circuit? This process
                            cannot be undone</p>
                </div>
                <div class="flex items-center justify-center gap-3 w-full">
                    ...
                    <form action="{{ route('circuits.publish', $circuit) }}" method="post">
                        ...
                        <button
                            class="cursor-pointer p-2 font-semiboldz text-gray-100 no-underline bg-alpha rounded-lg shadow-md hover:shadow-lg hover:text-alpha hover:bg-gray-100 border-2 border-alpha transition duration-500 ">
                            Publish Circuit
                        </button>
                    </form>
                </div>
